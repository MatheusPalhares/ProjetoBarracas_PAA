...
for simplex in hull_M.simplices:
        plt.plot(aux1_final[simplex, 0], aux1_final[simplex, 1], color='black')
for simplex in hull_W.simplices:
        plt.plot(aux2_final[simplex, 0], aux2_final[simplex, 1], color='black')
...
if(overlapping):
    result = "Não é possível separar"
else:
    result = "É possível separar"
